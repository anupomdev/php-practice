<?php
        ...
        $sel = "SELECT * FROM anupom WHERE id = $users_id";
        $qq = mysqli_query($db, $sel);
        $assocq = mysqli_fetch_assoc($qq);
...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            <a href="dashboard.php" class="sl-menu-link <?= $url == 'dashboard.php' ? 'active' : '' ?> ">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                    <span class="menu-item-label">Dashboard</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <a href="#" class="sl-menu-link <?= $url == 'add_service.php' ? 'active' : $url == 'service_view.php' ? 'active' : $url == 'trashed_service.php' ? 'active' : '' ?>">
                <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item">
                    <a href="add_service.php" class="nav-link">add service</a>
                </li>
                <li class="nav-item">
                    <a href="service_view.php" class="nav-link">view service</a>
                </li>
                <li class="nav-item">
                    <a href="trashed_service.php" class="nav-link">trashed service</a>
                </li>
            </ul>
            <a href="#" class="sl-menu-link <?= $url == 'add_education.php' ? 'active' : $url == 'education_view.php' ? 'active' : $url == 'trashed_education.php' ? 'active' : '' ?>">
                <div class="sl-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item">
                    <a href="add_education.php" class="nav-link">add Education</a>
                </li>
                <li class="nav-item">
                    <a href="education_view.php" class="nav-link">view Education</a>
                </li>
                <li class="nav-item">
                    <a href="trashed_education.php" class="nav-link">trashed Education</a>
                </li>
            </ul>
            <a href="messages.php" class="sl-menu-link <?= $url == 'messages.php' ? 'active' : '' ?> ">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            ...
            <nav class="nav">
                <div class="dropdown">
                    <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                        <span class="logged-name"><?php echo $assocq['name']  ?><span class="hidden-md-down"></span></span>
                        <img src="upload/<?php echo $assocq['images'] ?>" class="wd-32 rounded-circle" alt="">
                    </a>
    ...
    <div class="sl-sideright">
        ...
        <?php 
            $select = "SELECT * FROM contacts where read_status = 1";
                    ...
                    <?php foreach ($message as $key => $msg): ?>
                        ...
                        <div class="media">
                            <div class="media-body">
                                ...
                                <span class="d-block tx-11 tx-gray-500"><?= $msg['create_time'] ?></span>
                                <p class="tx-13 mg-t-10 mg-b-0"><?= $msg['message'] ?></p>
                            </div>
                        </div><!-- media -->
                    </a>
                    <?php endforeach  ?>
